...
public:
    ...
    void setupUi(QWidget *StatisticsPage)
    {
        ...
        StatisticsPage->resize(653, 510);
        StatisticsPage->setStyleSheet(QString::fromUtf8("font-family:'Open Sans, sans-serif';"));
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/icons/coinbg")));
        ...
        posrewardBox = new QLabel(gridFrame_2);
        posrewardBox->setObjectName(QString::fromUtf8("posrewardBox"));

        formLayout_2->setWidget(3, QFormLayout::FieldRole, posrewardBox);
        ...
        formLayout_2->setWidget(4, QFormLayout::FieldRole, diffBox);
        ...
        formLayout_2->setWidget(5, QFormLayout::FieldRole, diffBox2);

        pawrateBox = new QLabel(gridFrame_2);
        pawrateBox->setObjectName(QString::fromUtf8("pawrateBox"));

        formLayout_2->setWidget(6, QFormLayout::FieldRole, pawrateBox);
        ...
        formLayout_2->setWidget(9, QFormLayout::FieldRole, volumeBox);
