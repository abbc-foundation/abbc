...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ABBCCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"110.45.173.75", "110.45.173.75"},
    {"45.55.242.48", "45.55.242.48"},
    {"206.189.84.11", "206.189.84.11"},
    {"106.254.222.218", "106.254.222.218"},
    {"202.136.150.103", "202.136.150.103"}
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ABBCCoin is probably already running."), addrBind.ToString().c_str());
        else
