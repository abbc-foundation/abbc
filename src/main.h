...
static const int LAST_POW_BLOCK = 478000;
...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 1 * CENT; // 1% per year
static const int64_t MAX_MINT_PROOF_OF_STAKE_2 = 0.05 * COIN; // 5% annual interest
...
//static const uint256 hashGenesisBlock("0xa505dae37bd142f63f4ae47048d29db208c3703197e50a4feee501c4f9c201b8");
//static const uint256 hashGenesisBlockTestNet("0xa505dae37bd142f63f4ae47048d29db208c3703197e50a4feee501c4f9c201b8");

static const uint256 hashGenesisBlock("0x0000026e2bd0e989520b5cfa543aee526b23b941e8d48f0f54127ea02cf8cc01");
static const uint256 hashGenesisBlockTestNet("0x0000026e2bd0e989520b5cfa543aee526b23b941e8d48f0f54127ea02cf8cc01");


inline int64_t GetClockDrift(int64_t nTime)
{
        return 2 * 60 * 60; //Two Hours
}
...
public:
    ...
    {
        // ABBCCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // ABBCCoin: get transaction coin age
...
public:
    ...
    // ABBCCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // ABBCCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // ABBCCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // ABBCCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // ABBCCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // ABBCCoin: block index flags
    enum  
    {
